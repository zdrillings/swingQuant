...
CREATE TABLE IF NOT EXISTS universe_daily_snapshots (
    ...
    atr_14 DOUBLE,
    atr_pct_14 DOUBLE,
    atr_pct_14_percentile_252 DOUBLE,
    realized_vol_20_percentile_252 DOUBLE,
    ...
    dollar_volume_ratio_20_60 DOUBLE,
    volume_percentile_60 DOUBLE,
    distance_from_52w_high DOUBLE,
    days_since_52w_high DOUBLE,
    rsi_2 DOUBLE,
    ret_1d DOUBLE,
    ret_5d DOUBLE,
    close_vs_20d_low DOUBLE,
    sector_pct_above_50 DOUBLE,
    sector_pct_above_200 DOUBLE,
    sector_median_roc_63 DOUBLE,
    spy_roc_20 DOUBLE,
    spy_roc_5 DOUBLE,
    spy_realized_vol_20 DOUBLE,
    qqq_roc_20 DOUBLE,
    analyst_target_upside DOUBLE,
    analyst_target_range_pct DOUBLE,
    analyst_count DOUBLE,
    analyst_recommendation_score DOUBLE,
    analyst_eps_revision_breadth DOUBLE,
    analyst_upgrade_downgrade_score DOUBLE,
    analyst_snapshot_age_days DOUBLE,
    analyst_revision_snapshot_age_days DOUBLE,
...
class DatabaseManager:
    ...
    def _migrate_duckdb_schema(self, connection) -> None:
        for statement in [
            ...
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS realized_vol_20_percentile_252 DOUBLE",
            ...
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS dollar_volume_ratio_20_60 DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS volume_percentile_60 DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS distance_from_52w_high DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS days_since_52w_high DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS rsi_2 DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS ret_1d DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS ret_5d DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS close_vs_20d_low DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS spy_roc_20 DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS spy_roc_5 DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS spy_realized_vol_20 DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS qqq_roc_20 DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS analyst_target_upside DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS analyst_target_range_pct DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS analyst_count DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS analyst_recommendation_score DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS analyst_eps_revision_breadth DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS analyst_upgrade_downgrade_score DOUBLE",
            ...
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS fwd_return_60d DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS alpha_vs_spy_60d DOUBLE",
            "ALTER TABLE universe_daily_snapshots ADD COLUMN IF NOT EXISTS alpha_vs_sector_60d DOUBLE",
            ...
            connection.executemany(
                ...
                [
                    (
                        ...
                        row.get("atr_14"),
                        row.get("atr_pct_14"),
                        row.get("atr_pct_14_percentile_252"),
                        row.get("realized_vol_20_percentile_252"),
                        ...
                        row.get("days_since_52w_high"),
                        row.get("rsi_2"),
                        row.get("ret_1d"),
                        row.get("ret_5d"),
                        row.get("close_vs_20d_low"),
                        ...
                        row.get("dollar_volume_ratio_20_60"),
                        row.get("volume_percentile_60"),
                        row.get("sector_pct_above_50"),
                        row.get("sector_pct_above_200"),
                        row.get("sector_median_roc_63"),
                        row.get("spy_roc_20"),
                        row.get("spy_roc_5"),
                        row.get("spy_realized_vol_20"),
                        row.get("qqq_roc_20"),
                        row.get("analyst_target_upside"),
                        row.get("analyst_target_range_pct"),
                        row.get("analyst_count"),
                        row.get("analyst_recommendation_score"),
                        row.get("analyst_eps_revision_breadth"),
                        row.get("analyst_upgrade_downgrade_score"),
                        row.get("analyst_snapshot_age_days"),
                        row.get("analyst_revision_snapshot_age_days"),
                        ...
                        row.get("fwd_return_10d"),
                        row.get("fwd_return_20d"),
                        row.get("fwd_return_60d"),
                        row.get("alpha_vs_spy_1d"),
                        row.get("alpha_vs_spy_3d"),
                        row.get("alpha_vs_spy_5d"),
                        row.get("alpha_vs_spy_10d"),
                        row.get("alpha_vs_spy_20d"),
                        row.get("alpha_vs_spy_60d"),
                        row.get("alpha_vs_sector_1d"),
                        row.get("alpha_vs_sector_3d"),
                        row.get("alpha_vs_sector_5d"),
                        row.get("alpha_vs_sector_10d"),
                        row.get("alpha_vs_sector_20d"),
                        row.get("alpha_vs_sector_60d"),
